<x-layout title="Department Details">
    ...
    <style>
        ...
        .department-location-block {
            font-size: 15px; color: var(--primary-soft);
        ...
        .detail-card {
            background: #fcfcfc; padding: 20px; border-radius: 12px;
        ...
        .description-content {
            font-size: 15px; line-height: 1.7; color: var(--primary-soft);
        ...
        .verification-actions {
            background: #fcfcfc; padding: 20px; border-radius: 16px;
        ...
        .modal-content { max-width: 90%; max-height: 90%; border-radius: 8px; box-shadow: 0 20px 50px rgba(0,0,0,0.5); }
        .close-modal {
